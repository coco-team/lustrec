...
let fmt_prefix fmt name =
  let typ = name |> String.capitalize in
  Format.fprintf fmt "\
//! Implementation for lustre file `%s` (see [%s](struct.%s.html)).
//!
//! Code generated by the [LustreC -- Lustre Compiler][lustrec].
//!
//! [lustrec]: https://github.com/coco-team/lustrec (Lustre Compiler)
...
let print_lib_rust source_fmt basename prog machines dependencies =
  ...
  fmt_prefix source_fmt basename;
  fmt_main source_fmt ();

  (* Print the struct definitions of all machines. *)
  fprintf source_fmt "// Sub Nodes @.";
